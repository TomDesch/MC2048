...
public enum ConfigKey {
    ...
    PLAY_BUTTON_MATERIAL("NETHERITE_UPGRADE_SMITHING_TEMPLATE"),
    PLAY_BUTTON_MATERIAL_CMD("1000"),
    PLAY_BUTTON_NAME("Click to play!"),
    PLAY_BUTTON_LORE("Click to play the iconic 2048 game!"),
